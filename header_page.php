...
<html lang="es">
  <head>
    ...
    <!-- para hacer el efecto del logo que tiembla-->
     ...
     <!-- para el efecto paralax del titulo, categoria, publicado hace. al mover el scroll-->
     <script>
        $(document).on("ready", gogogo);
        function gogogo(){
                 var scrollorama = $.scrollorama({ blocks:'#scrollrama' });   

                scrollorama.animate('.paralax2',{ delay: 20, duration: 20, property:'top', start:5, end:-40 });
                scrollorama.animate('.paralax2',{ delay:40, duration: 20, property:'opacity', start:1,end:0});
                scrollorama.animate('.paralax3',{ delay: 20, duration:20, property:'top', start:10, end:-80 });
                scrollorama.animate('.paralax3',{ delay:40, duration: 20, property:'opacity', start:1,end:0});
